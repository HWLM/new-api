...
func SetVideoRouter(router *gin.Engine) {
	...
	seedanceV3AssetGetRouter.Use(middleware.SeedanceV3AssetRequestConvert(), middleware.TokenAuth(), middleware.Distribute())
	{
		seedanceV3AssetGetRouter.POST("/GetAsset", controller.RelaySeedanceV3Asset)
	}

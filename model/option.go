...
func InitOptionMap() {
	...
	common.OptionMap["PricingDiscountColumnEnabled"] = strconv.FormatBool(common.PricingDiscountColumnEnabled)
	...
	common.OptionMap["MetaDescription"] = ""
	common.OptionMap["AnalyticsScript"] = ""
	...
	common.OptionMap["ConsumeUSDExchangeRate"] = strconv.FormatFloat(operation_setting.ConsumeUSDExchangeRate, 'f', -1, 64)
	...
	common.OptionMap["DisplayUserSelfGroup"] = strconv.FormatBool(setting.DisplayUserSelfGroup)
	...
	common.OptionMap[OptionKeyOfficialUserGroups] = ""
...
func updateOptionMap(key string, value string) (err error) {
	...
	if strings.HasSuffix(key, "Enabled") || key == "DefaultCollapseSidebar" || key == "DefaultUseAutoGroup" || key == "DisplayUserSelfGroup" || key == "SMTPForceAuthLogin" || key == "SMTPInsecureSkipVerify" {
		...
		case "PricingDiscountColumnEnabled":
			common.PricingDiscountColumnEnabled = boolValue
		case "DrawingEnabled":
		...
		case "DisplayUserSelfGroup":
			setting.DisplayUserSelfGroup = boolValue
	...
	case "ConsumeUSDExchangeRate":
		operation_setting.ConsumeUSDExchangeRate, _ = strconv.ParseFloat(value, 64)
	case "MinTopUp":

...
func migrateDB() error {
	...
	err := DB.AutoMigrate(
		...
		&UpstreamCandidate{},
		&BusinessCooperation{},
		&UpstreamBenchmarkRun{},
		&UpstreamBenchmarkProfile{},
	)
	if err != nil {
		return err
	}
...
func migrateDBFast() error {
	...
	migrations := []struct {
		...
		{&TokenQuotaData{}, "TokenQuotaData"},
		{&TokenExhaustingSnapshot{}, "TokenExhaustingSnapshot"},
		{&SystemInstance{}, "SystemInstance"},
		{&SystemTask{}, "SystemTask"},
		{&SystemTaskLock{}, "SystemTaskLock"},
		{&UpstreamCandidate{}, "UpstreamCandidate"},
		{&BusinessCooperation{}, "BusinessCooperation"},
		{&UpstreamBenchmarkRun{}, "UpstreamBenchmarkRun"},
		{&UpstreamBenchmarkProfile{}, "UpstreamBenchmarkProfile"},
	}
